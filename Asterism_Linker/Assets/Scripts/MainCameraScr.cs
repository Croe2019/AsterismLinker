...
public class MainCameraScr : MonoBehaviour
{
    ...
    public GameObject[] no_seed_small;
    ...
    private int english_save = 0;

    private int temp_temp = 0;
    ...
    //操作説明の英語版オブジェ
    public GameObject[] english_manual = new GameObject[10];
    ...
    public GameObject english_manual_2;
    ...
    public GameObject english_mission_obj;
    //ゲームスタート前のミッション表示
	...
	*/
    void Update()
    {
        ...
        else if (main_move_state == -2)
        {
            if (StageSelectManager.ST_OWNER_NUMBER == "2_1")
            {
                ...
                else if(Application.systemLanguage == SystemLanguage.English)
                {
                    if (ended_state == 0)
                    {
                        english_manual_2.SetActive(true);
                    }
                }
                ...
                if (info_m == TouchInfo.Ended)
                {
                    if (ended_state == 0)
                    {
                        ...
                        english_manual_2.SetActive(false);
                        ...
                        else 
                        {
                            ...
                            english_mission_obj.SetActive(true);
                            // 2-1
                            if (PlayerPrefs.GetInt("2_1_1") != 0)
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_1").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 1);
                            }
                            else
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_1").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 0);
                            }

                            if (PlayerPrefs.GetInt("2_1_2") != 0)
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_2").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 1);
                            }
                            else
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_2").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 0);
                            }

                            if (PlayerPrefs.GetInt("2_1_3") != 0)
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_3").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 1);
                            }
                            else
                            {
                                GameObject.Find("Common/Canvas/English_Missiton_Start/E_Start_3").gameObject.GetComponent<Image>().color = new Color(1, 1, 1, 0);
                            }
                        }
                        //english_manual_2.SetActive(false);
                    ...
                    else if (ended_state >= 1)
                    {
                        main_move_state = -1;
                        mission_obj.SetActive(false);
                        english_mission_obj.SetActive(false);
                    }
                    ended_state += 1;
                }
            }
            else
            {
                ...
                if (Application.systemLanguage == SystemLanguage.Japanese)
                {
                    ...
                    if (info_m == TouchInfo.Ended)
                    {
                        ...
                        {
                            manual[temp_temp - 1].SetActive(false);
                        }
                        else
                        {
                            mission_obj.SetActive(false);
                    ...
                    if (st_owner != null)
                    {
                        ...
                        if (st_owner == "1")
                        {
                            ...
                            for (int i = 1; i <= 10; i++)
                            {
                                if (StageSelectManager.ST_OWNER_NUMBER == ("1_" + i.ToString()))
                                {
                                    english_manual[i - 1].SetActive(true);
                                    temp_temp = i;
                                    temp_save = temp_temp;
                        ...
                        if (info_m == TouchInfo.Ended)
                        {
                            ...
                            if (st_owner != null && st_owner == "1")
                            {
                                english_manual[temp_temp - 1].SetActive(false);
                            }
                            else
                            {
                                //mission_obj.SetActive(false);
        ...
        no_seed_small = GameObject.FindGameObjectsWithTag("No_Seed_Green_Block");
                    ...
                    else if (collition2d.gameObject.name == "Question")
                    {
                        if (Application.systemLanguage == SystemLanguage.Japanese)
                        {
                            ...
                            if (st != "1")
                            {
                                ...
                                //GameObject.Find("Common/Canvas/English_Right").SetActive(true);
                                //GameObject.Find("Common/Canvas/English_Left").SetActive(true);
                                ...
                                //GameObject.Find("Common/Canvas/English_Tutorial").GetComponent<Tutorial_Manager>().English_Tutorial_Call(0);
                            ...
                            if (english_manual[temp_save - 1].activeSelf)
                            {
                                english_manual[temp_save - 1].SetActive(false);
                            }
                        ...
                        else
                        {
                            ...
                            if (st != "1")
                            {
                                ...
                                GameObject.Find("Question").SetActive(false);
                                GameObject.Find("Common/Canvas/Tutorial").SetActive(true);
                                GameObject.Find("Common/Canvas/English_Tutorial").SetActive(true);
                                GameObject.Find("Common/Canvas/pause_black/Retry").SetActive(false);
                                GameObject.Find("Common/Canvas/pause_black/Stage_Select").SetActive(false);
                                GameObject.Find("Common/Canvas/Right").SetActive(true);
                                GameObject.Find("Common/Canvas/Left").SetActive(true);
                            ...
                            else
                            {
                                ...
                                if (st_1 == "1")
                                {
                                    ...
                                    english_manual[temp_save - 1].SetActive(true);
                                    GameObject.Find("Common/Canvas/pause_black/Question").SetActive(false);
                                    GameObject.Find("Common/Canvas/pause_black/Retry").SetActive(false);
                                    GameObject.Find("Common/Canvas/pause_black/Stage_Select").SetActive(false);
                    ...
                    else if (collition2d.gameObject.name == "pause")
                    {
                        ...
                        if (english_manual[temp_save - 1].activeSelf)
                        {
                            ...
                            if (st != "1")
                            {
                                ...
                                GameObject.Find("Common/Canvas/English_Tutorial").SetActive(false);
        ...
        if (main_move_state == 2)
        {
            ...
            if (GameObject.Find("Player").GetComponent<Rigidbody2D>().velocity.magnitude < nature_change_blue)
            {
                ...
                if (bonus_nature_change_yellow == 1 && bonus_color_yellow < CHANGE_COLOR_DELAY_COUNT)
                {
                    ...
                    foreach (GameObject obs in no_seed_small)
                    {
                        obs.GetComponent<Collider2D>().isTrigger = false;
                    }
